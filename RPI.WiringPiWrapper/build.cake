...
var destinationIp = Argument("destinationPi", "192.168.8.110");
var destinationDirectory = Argument("destinationDirectory", @"/home/pi/Templates/FirstBlinker");
var username = Argument("username", "pi");
var executableName = Argument("executableName", "RPI.WiringPiWrapper");
var sessionname = Argument("sessionname", "firstjrpitests");
