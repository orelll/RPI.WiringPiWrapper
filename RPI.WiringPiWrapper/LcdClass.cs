...
namespace RPI.WiringPiWrapper
{
    public class LcdClass
    {
        ...
        public LcdClass()
        {
            ...
            lcd_device.write_cmd(0x03);
            lcd_device.write_cmd(0x03);
            lcd_device.write_cmd(0x03);
            lcd_device.write_cmd(0x02);

            lcd_device.write_cmd(LCD_FUNCTIONSET | LCD_2LINE | LCD_5x8DOTS | LCD_4BITMODE);
            lcd_device.write_cmd(LCD_DISPLAYCONTROL | LCD_DISPLAYON);
            lcd_device.write_cmd(LCD_CLEARDISPLAY);
            lcd_device.write_cmd(LCD_ENTRYMODESET | LCD_ENTRYLEFT);
            Thread.Sleep(1);
        }
        ...
        {
            lcd_device.write_cmd(data | En | LCD_BACKLIGHT);
            Thread.Sleep(1);
            lcd_device.write_cmd(((data & ~En) | LCD_BACKLIGHT));
            Thread.Sleep(1);
        }
        ...
        {
            lcd_device.write_cmd(data | LCD_BACKLIGHT);
            lcd_strobe(data);
        }
